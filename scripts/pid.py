...
import time
import tf
#from move_tbot3.py import n_robots
...
class PID(object):
	...
	def __init__(self, target_pose, mode,robot):
		...
		rospy.Subscriber(self.robot+'/odom', Odometry, self.pose_callback, queue_size=1)
		#.Subscriber(self.robot2+'/odom', Odometry, self.pose_callback, queue_size=1)
		#rospy.Subscriber(robot+'/robot2/odom', Odometry, self.pose_callback, queue_size=1)
		self.velocity_publisher = rospy.Publisher(self.robot+'/cmd_vel', Twist, queue_size=1)
		#self.velocity_publisher = rospy.Publisher(self.robot2+'/cmd_vel', Twist, queue_size=1)
		#self.velocity_publisher = rospy.Publisher('/robot2/cmd_vel', Twist, queue_size=1)
